...
namespace app {
    ...
    public:
        TreeSet(typename ISet<K>::Comparator comparator = nullptr) { _tree = new RBTree<K>(comparator); }
        ...
        void traverse(TraverseFunc func = nullptr) { _tree->traverse(RBTree<K>::TraverseOrder::In, func); }
