...
protected:
    ...
    virtual bool contains_key(std::shared_ptr<K> key) = 0;
    virtual bool contains_value(std::shared_ptr<V> value) = 0;
    virtual std::shared_ptr<V> get_value(std::shared_ptr<K> key) = 0;
